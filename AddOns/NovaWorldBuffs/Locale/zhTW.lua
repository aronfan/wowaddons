...
L["dmfBuffCooldownMsg"] = "你的暗月馬戲團buff倒數剩下 %s 。";
L["dmfBuffReady"] = "你的暗月馬戲團buff已經停止倒數。";
L["dmfBuffReset"] = "你的暗月馬戲團buff冷卻時間已經重製。";
L["dmfBuffDropped"] = "暗月馬戲團buff %s 已取得, 您可以使用 /dmf，查詢遊戲內冷卻時間，以再次獲得馬戲團buff。";
...
L["West Felpaw Village"] = "魔轉村西邊"; --Felwood map subzones (flower2).
