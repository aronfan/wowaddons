...
local projectVersion = "8.7.4-classic" -- comes out like "6.2.2-21-g4e91cee"
...
TELLMEWHEN_VERSIONNUMBER = 87402 -- NEVER DECREASE THIS NUMBER (duh?).  IT IS ALSO ONLY INTERNAL (for versioning of)
